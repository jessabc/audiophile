...
<div className="flex flex-col gap-2 mb-5">
  ...
  `}>
    <label htmlFor="name" className={`font-bold text-sm leading-4 tracking-tighter text-black ${errors.name ? 'text-error': ''}`}>Name</label> 
<p className={`font-medium text-sm leading-4 tracking-tight text-error`}>{errors.name?.message}</p>
  </div>
   
<input id="name" placeholder="Alexei Ward" {...register("name")} className={` font-bold text-sm leading-5 tracking-tight   py-2 pl-4 rounded-lg border border-solid border-black border-opacity-30  focus:outline-orange  caret-orange w-full ${errors.name ? 'focus:outline-error ': ''}`}/>
</div>
...
<div className={`flex justify-between items-center
  `}>
<label htmlFor="email"  className={`font-bold text-sm leading-4 tracking-tighter text-black ${errors.name ? 'text-error': ''}`}>Email</label> 
<p className={`font-medium text-sm leading-4 tracking-tight text-error`}>{errors.email?.message}</p>
</div>
<input id="email" placeholder="alexei@mail.com"  {...register("email")} className={` font-bold text-sm leading-5 tracking-tight   py-2 pl-4 rounded-lg border border-solid border-black border-opacity-30  focus:outline-orange  caret-orange w-full ${errors.name ? 'focus:outline-error ': ''}`} />
...
<label htmlFor="phone" className={`font-bold text-sm leading-4 tracking-tighter text-black ${errors.name ? 'text-error': ''}`}>Phone</label> 
